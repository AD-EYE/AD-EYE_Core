...
if("TRUE" STREQUAL "TRUE")
  set(pc2_downsampler_SOURCE_PREFIX /home/adeye/AD-EYE_Core/autoware.ai/src/autoware/utilities/pc2_downsampler)
  set(pc2_downsampler_DEVEL_PREFIX /home/adeye/AD-EYE_Core/autoware.ai/devel)
  ...
  set(pc2_downsampler_INSTALL_PREFIX /home/adeye/AD-EYE_Core/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pc2_downsampler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adeye/AD-EYE_Core/autoware.ai/src/autoware/utilities/pc2_downsampler/${idir}'.  ${_report}")
    endif()
