...
if("TRUE" STREQUAL "TRUE")
  set(kitti_launch_SOURCE_PREFIX /home/adeye/AD-EYE_Core/autoware.ai/src/autoware/utilities/kitti_launch)
  set(kitti_launch_DEVEL_PREFIX /home/adeye/AD-EYE_Core/autoware.ai/devel)
  ...
  set(kitti_launch_INSTALL_PREFIX /home/adeye/AD-EYE_Core/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kitti_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adeye/AD-EYE_Core/autoware.ai/src/autoware/utilities/kitti_launch/${idir}'.  ${_report}")
    endif()
