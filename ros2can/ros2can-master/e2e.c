...
//check counter increment TODO: figure out how many times to increment in each pass (1 time? 2 times?)
uint8_t IncrementCounter(uint8_t *data_ptr){
...
//Crc calculations used for the different profiles
