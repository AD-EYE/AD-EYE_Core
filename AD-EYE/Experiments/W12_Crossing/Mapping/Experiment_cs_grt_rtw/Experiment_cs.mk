###########################################################################
## Makefile generated for Simulink model 'Experiment_cs'. 
## 
## Makefile     : Experiment_cs.mk
## Generated on : Tue Feb 09 22:39:42 2021
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Experiment_cs.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/adeye/AD-EYE_Core/AD-EYE/Experiments/W12_Crossing/Mapping
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
...
COMPILER_COMMAND_FILE     = Experiment_cs_comp.rsp
CMD_FILE                  = Experiment_cs.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Experiment_cs.exe
...
DEFINES_STANDARD = -DMODEL=Experiment_cs -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Experiment_cs_grt_rtw/Experiment_cs.c $(START_DIR)/Experiment_cs_grt_rtw/Experiment_cs_data.c $(START_DIR)/Experiment_cs_grt_rtw/rtGetInf.c $(START_DIR)/Experiment_cs_grt_rtw/rtGetNaN.c $(START_DIR)/Experiment_cs_grt_rtw/rt_nonfinite.c prescan_LogHandler.c prescan_ErrorHandler.c prescan_Modify.c rt_sim.c $(MATLAB_ROOT)/rtw/c/grt/classic_main.c
...
OBJS = rt_logging.obj Experiment_cs.obj Experiment_cs_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj prescan_LogHandler.obj prescan_ErrorHandler.obj prescan_Modify.obj rt_sim.obj classic_main.obj
...
%.obj : $(START_DIR)/Experiment_cs_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Experiment_cs_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
