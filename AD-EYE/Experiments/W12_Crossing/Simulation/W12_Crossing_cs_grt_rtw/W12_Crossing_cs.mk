###########################################################################
## Makefile generated for Simulink model 'W12_Crossing_cs'. 
## 
## Makefile     : W12_Crossing_cs.mk
## Generated on : Wed Feb 10 17:20:43 2021
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/W12_Crossing_cs.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/adeye/AD-EYE_Core/AD-EYE/Experiments/W12_Crossing/simulation
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
...
COMPILER_COMMAND_FILE     = W12_Crossing_cs_comp.rsp
CMD_FILE                  = W12_Crossing_cs.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/W12_Crossing_cs.exe
...
DEFINES_STANDARD = -DMODEL=W12_Crossing_cs -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/W12_Crossing_cs_grt_rtw/W12_Crossing_cs.c $(START_DIR)/W12_Crossing_cs_grt_rtw/W12_Crossing_cs_data.c $(START_DIR)/W12_Crossing_cs_grt_rtw/rtGetInf.c $(START_DIR)/W12_Crossing_cs_grt_rtw/rtGetNaN.c $(START_DIR)/W12_Crossing_cs_grt_rtw/rt_nonfinite.c prescan_LogHandler.c prescan_ErrorHandler.c prescan_Modify.c rt_sim.c $(MATLAB_ROOT)/rtw/c/grt/classic_main.c
...
OBJS = rt_logging.obj W12_Crossing_cs.obj W12_Crossing_cs_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj prescan_LogHandler.obj prescan_ErrorHandler.obj prescan_Modify.obj rt_sim.obj classic_main.obj
...
%.obj : C:/PROGRA~1/SIMCEN~1/PRESCA~1.1/SIMULA~1/include/platform/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/PROGRA~1/SIMCEN~1/PRESCA~1.1/SIMULA~1/include/platform/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : C:/PROGRA~1/SIMCEN~1/PRESCA~1.1/SIMULA~1/include/platform/grt/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/PROGRA~1/SIMCEN~1/PRESCA~1.1/SIMULA~1/include/platform/grt/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : C:/Users/adeye/AppData/Roaming/Prescan/2020.1.0/sfunction_R2019a/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/Users/adeye/AppData/Roaming/Prescan/2020.1.0/sfunction_R2019a/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/W12_Crossing_cs_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/W12_Crossing_cs_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
