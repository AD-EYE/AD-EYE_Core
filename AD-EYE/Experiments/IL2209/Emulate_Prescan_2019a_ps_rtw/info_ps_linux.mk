...
PRESCANCORE = /usr/local/Prescan_2020.3.0
PRESCANHEADERS = /usr/local/Prescan_2020.3.0/include
PRESCANMODULES = /usr/local/Prescan_2020.3.0/modules
OPTIMIZATION_FLAGS = -O0 -fPIC
MODELLIB = Emulate_Prescan_2019a.a
...
PRESCAN_INCLUDES = \
  ...
  -I$(PRESCANMODULES)/LMS/include_interface \
  ...
  -I$(PRESCANMODULES)/PrescanViewer/include_interface \
