...
MODEL                = Emulate_Prescan_2019a
MODULES              = rt_logging.c Emulate_Prescan_2019a_capi.c Emulate_Prescan_2019a_data.c Emulate_Prescan_2019a_prescan.c detect_tunability_loss.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
NCSTATES             = 0
#####COMPUTER             = #>COMPUTER<#
BUILDARGS            =  MODELLIB=Emulate_Prescan_2019alib.lib MAT_FILE=1 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
EXT_MODE             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/Emulate_Prescan_2019a_ps_rtw \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
...
%.o : $(START_DIR)/Emulate_Prescan_2019a_ps_rtw/%.c
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : $(START_DIR)/Emulate_Prescan_2019a_ps_rtw/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
