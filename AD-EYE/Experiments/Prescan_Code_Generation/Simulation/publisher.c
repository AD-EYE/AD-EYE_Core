 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun Jan 10 12:40:44 2021
 */
...
/* Parameter 1 */
#define PARAMETER_1_NAME      timeout
...
static void mdlStart(SimStruct *S)
{
    ...
    const real_T *timeout = (const real_T *) mxGetData(PARAM_DEF1(S));
    
    publisher_Start_wrapper(pW, port, p_width0, timeout, p_width1);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    publisher_Outputs_wrapper(data, pW, port, p_width0, timeout, p_width1);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    publisher_Terminate_wrapper(pW, port, p_width0, timeout, p_width1);
