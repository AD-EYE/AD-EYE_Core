 ...
 *
 */
void clock_publisher_Start_wrapper(void **pW,
 ...
 *
 */
void clock_publisher_Outputs_wrapper(const real_T *secs,
			const real_T *nsecs,
			void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
...
publish_to_topic_clock(pW[0], topic_str, secs[0], nsecs[0]);
 ...
 *
 */
void clock_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3)
