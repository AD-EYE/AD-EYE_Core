 ...
 *
 */
void TwistStamped_publisher_Start_wrapper(void **pW,
 ...
 *
 */
void TwistStamped_publisher_Outputs_wrapper(const real_T *seq,
...
publish_to_topic_twiststamped(pW[0], topic_str, seq[0], frameId_length[0], linearX[0], linearY[0], linearZ[0], angularX[0], angularY[0], angularZ[0]);
 ...
 *
 */
void TwistStamped_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3)
