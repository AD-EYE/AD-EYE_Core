 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jan 15 04:41:33 2021
 */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    PoseArray_publisher_Outputs_wrapper(seq, frameId, frameId_length, positionX, positionY, positionZ, orientationW, orientationX, orientationY, orientationZ, poses_length, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
