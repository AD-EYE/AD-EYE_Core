 ...
 *
 */
void bool_publisher_Start_wrapper(void **pW,
 ...
 *
 */
void bool_publisher_Outputs_wrapper(const boolean_T *data,
			void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
...
publish_to_topic_bool(pW[0], topic_str, data[0]);
 ...
 *
 */
void bool_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3)
