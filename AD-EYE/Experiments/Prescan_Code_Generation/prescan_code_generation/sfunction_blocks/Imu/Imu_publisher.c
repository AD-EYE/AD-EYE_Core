 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Feb 20 19:44:45 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Imu_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            9
/* Input Port  0 */
#define IN_PORT_0_NAME        orientW
...
/* Input Port  4 */
#define IN_PORT_4_NAME        angularZ
...
/* Input Port  5 */
#define IN_PORT_5_NAME        linearAccX
...
/* Input Port  6 */
#define IN_PORT_6_NAME        linearAccZ
...
/* Input Port  8 */
#define IN_PORT_8_NAME        frameId_length
...
static void mdlStart(SimStruct *S)
{
    ...
    Imu_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    const real_T *orientW = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *orientX = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *orientY = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *orientZ = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *angularZ = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *linearAccX = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *linearAccZ = (real_T *) ssGetInputPortRealSignal(S, 6);
    const real_T *seq = (real_T *) ssGetInputPortRealSignal(S, 7);
    const real_T *frameId_length = (real_T *) ssGetInputPortRealSignal(S, 8);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    Imu_publisher_Outputs_wrapper(orientW, orientX, orientY, orientZ, angularZ, linearAccX, linearAccZ, seq, frameId_length, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    Imu_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
