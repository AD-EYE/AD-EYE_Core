 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Feb 20 19:52:00 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Pose_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            7
/* Input Port  0 */
#define IN_PORT_0_NAME        positionX
...
/* Input Port  1 */
#define IN_PORT_1_NAME        positionY
...
/* Input Port  2 */
#define IN_PORT_2_NAME        positionZ
...
/* Input Port  3 */
#define IN_PORT_3_NAME        orientationW
...
/* Input Port  4 */
#define IN_PORT_4_NAME        orientationX
...
/* Input Port  5 */
#define IN_PORT_5_NAME        orientationY
...
/* Input Port  6 */
#define IN_PORT_6_NAME        orientationZ
...
static void mdlStart(SimStruct *S)
{
    ...
    Pose_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    const real_T *positionX = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *positionY = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *positionZ = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *orientationW = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *orientationX = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *orientationY = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *orientationZ = (real_T *) ssGetInputPortRealSignal(S, 6);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    Pose_publisher_Outputs_wrapper(positionX, positionY, positionZ, orientationW, orientationX, orientationY, orientationZ, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    Pose_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
