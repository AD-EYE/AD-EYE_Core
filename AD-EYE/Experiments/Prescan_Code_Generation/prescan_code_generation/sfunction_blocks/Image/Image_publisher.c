 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Feb 20 19:43:54 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Image_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            7
/* Input Port  0 */
#define IN_PORT_0_NAME        height
...
static void mdlStart(SimStruct *S)
{
    ...
    const int8_T *frame_id = (const int8_T *) mxGetData(PARAM_DEF2(S));
    const real_T *port = (const real_T *) mxGetData(PARAM_DEF3(S));
    const real_T *timeout = (const real_T *) mxGetData(PARAM_DEF4(S));
    
    Image_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, frame_id, p_width2, port, p_width3, timeout, p_width4);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Image_publisher_Outputs_wrapper(height, width, encoding_length, step, data, data_length, frameId_length, pW, topic, p_width0, message_type, p_width1, frame_id, p_width2, port, p_width3, timeout, p_width4);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    Image_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, frame_id, p_width2, port, p_width3, timeout, p_width4);
