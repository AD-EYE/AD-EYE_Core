/*
 * File: Float32MultiArray_publisher.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Feb 20 19:42:01 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Float32MultiArray_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    Float32MultiArray_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Float32MultiArray_publisher_Outputs_wrapper(data, size, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    Float32MultiArray_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
