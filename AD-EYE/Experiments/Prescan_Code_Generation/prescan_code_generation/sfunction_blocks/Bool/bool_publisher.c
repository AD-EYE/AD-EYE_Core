 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Feb 20 19:40:33 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME bool_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlStart(SimStruct *S)
{
    ...
    bool_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    const boolean_T *data = (boolean_T *) ssGetInputPortRealSignal(S, 0);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    bool_publisher_Outputs_wrapper(data, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    bool_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
