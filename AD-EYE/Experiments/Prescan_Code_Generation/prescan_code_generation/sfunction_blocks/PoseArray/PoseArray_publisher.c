 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Feb 20 19:52:50 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PoseArray_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void PoseArray_publisher_Start_wrapper(void **pW,
...
extern void PoseArray_publisher_Outputs_wrapper(const uint32_T *seq,
			...
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3);
extern void PoseArray_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3);
...
static void mdlStart(SimStruct *S)
{
    ...
    PoseArray_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
static void mdlTerminate(SimStruct *S)
{
    ...
    PoseArray_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
