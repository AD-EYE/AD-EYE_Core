...
static void Experiment_cs_output(void)
{
   ...
   */
  rtb_CCaller = create_connection(9090, 2);

  /* CCaller: '<Root>/C Caller1' incorporates:
   *  DataTypeConversion: '<Root>/Data Type Conversion'
   */
  publish_to_topic(rtb_CCaller, (real32_T)rtb_Path.VelocityX);
  ...
  *&Experiment_cs_DW.sfun_Controller_PWORK[0] = (void*)
...

  {
    ...
    addToSerializationBuffer(work1,
      ...
      "aWxkVGltZRIPMjAyMTAxMDFUMTcyNDA3EiEKDmV4cGlyYXRpb25UaW1lEg8yMDIxMDEwOFQxNzI0"
      "MDcSHAoYcGltcC9ncmFwaGJhc2Vkcm9hZG1vZGVsEgASvw4KEnBpbXAvc2NlbmFyaW9tb2RlbBKo"
...
RT_MODEL_Experiment_cs_T *Experiment_cs(void)
{
  ...
  Experiment_cs_M->Sizes.numBlocks = (22);/* Number of blocks */
