...
MASTER_ANCHOR_DIR    = 
START_DIR            = /home/adeye/prescan_code_generation/examples/prescan-tcp/publisher/Experiment-ubuntu/Experiment
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      =
SOLVER               = 
NUMST                = 2
...
%.o : $(START_DIR)/Experiment_cs_ps_rtw/%.c	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
