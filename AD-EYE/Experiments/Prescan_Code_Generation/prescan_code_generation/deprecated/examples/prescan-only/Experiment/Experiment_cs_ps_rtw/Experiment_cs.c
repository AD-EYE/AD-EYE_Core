  ...
  *&Experiment_cs_DW.sfun_Controller_PWORK[0] = (void*)
...

  {
    ...
    addToSerializationBuffer(work1,
      ...
      "aWxkVGltZRIPMjAyMDEyMTJUMTYwMTM1EiEKDmV4cGlyYXRpb25UaW1lEg8yMDIwMTIxOVQxNjAx"
      "MzUSHAoYcGltcC9ncmFwaGJhc2Vkcm9hZG1vZGVsEgASvw4KEnBpbXAvc2NlbmFyaW9tb2RlbBKo"
...
RT_MODEL_Experiment_cs_T *Experiment_cs(void)
{
  ...
  Experiment_cs_M->Sizes.numBlocks = (17);/* Number of blocks */
