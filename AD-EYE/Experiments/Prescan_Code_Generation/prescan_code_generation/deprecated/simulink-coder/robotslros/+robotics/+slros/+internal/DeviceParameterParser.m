classdef DeviceParameterParser < handle
    ...
    methods
        function [validHost, validSSHPort] = validateDeviceAddress(obj, deviceAddress, funcName, varName)
            ...
            validSSHPort = robotics.codertarget.internal.DeviceParameters.DefaultSSHPort;
            ...
            switch length(hostElements)
                ...
                case 2
                    ...
                    if isnan(sshPort)
                        error(message('robotics:robotslros:deviceparams:PortNotNumeric', char(hostElements(2))));
                    end
                ...
                otherwise
                    ...
                    error(message('robotics:ros:util:HostnameInvalid', deviceAddress));
            end
        ...
        function validateHostname(~, hostname, funcName, varName)
            ...
            if ~robotics.ros.internal.Net.isValidHost(hostname)
                error(message('robotics:ros:util:HostnameInvalid', hostname));
            end  
        end
