classdef ssh2client < handle
    ...
    methods
        ...
        function obj = ssh2client(hostname, username, password, port)
            ...
            try
                obj.IpNode = robotics.codertarget.internal.ipnode(hostname,port);
                obj.Credentials = robotics.codertarget.internal.credentials(username,password);
            catch ME
                throwAsCaller(ME);
            end 
    ...
    methods(Access = public)
        ...
        function openShell(obj)
            ...
            if ispc
                robotics.codertarget.internal.putty.openShell('ssh', ...
                    [obj.Hostname ...
                    ' -l ' obj.Credentials.Username ... 
                    ' -pw "' obj.Credentials.Password '"'])
            else
                robotics.codertarget.internal.nixssh.openShell(obj.Hostname, ...
                    obj.Credentials.Username);
            end
        end
    ...
    methods (Static, Hidden)
        function libPath = getLibraryPathVariable
            ...
            switch (arch)
                case 'win64'
                    libPath  = robotics.codertarget.internal.ssh2client.LibraryPathWin;
                case 'glnxa64'
                    libPath  = robotics.codertarget.internal.ssh2client.LibraryPathLinux;
                case 'maci64'
                    libPath  = robotics.codertarget.internal.ssh2client.LibraryPathMac;
            end
        end
    end
    ...
    methods (Static, Access = ?matlab.unittest.TestCase)
        function setupLIBSSHRuntime
            ...
            libpathvar = robotics.codertarget.internal.ssh2client.getLibraryPathVariable;
