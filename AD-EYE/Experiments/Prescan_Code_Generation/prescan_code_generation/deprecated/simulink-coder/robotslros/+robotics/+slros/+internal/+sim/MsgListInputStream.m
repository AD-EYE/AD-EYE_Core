classdef  MsgListInputStream < robotics.slros.internal.sim.MsgInputStream
    ...
    methods
        ...
        function setMessageList(obj, messageList)
            ...
            for i=1:numel(messageList)
               if ~(isa(messageList{i}, 'robotics.ros.Message') || isempty(messageList{i}))
                   error(message('robotics:robotslros:msgstream:InvalidMsgListInput', 'setMessageList'));
               end
            end
