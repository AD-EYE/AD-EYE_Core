classdef GetParameter < ...
        robotics.slros.internal.block.ParameterBase & ...
    ...
    %
    %   H = robotics.slros.internal.block.GetParameter creates a system
    ...
    %   ROSPARAM.
    %
    %   See also robotics.slros.internal.block.SetParameter
    ...
    properties (Constant, Access=?robotics.slros.internal.block.mixin.NodeDependent)
        ...
        MessageCatalogName = message('robotics:robotslros:blockmask:GetParameterTitle').getString
    end
    ...
    properties (Constant, Access = {?matlab.unittest.TestCase, ?robotics.slros.internal.block.GetParameterStateInterface, ?robotics.slros.internal.block.GetParameter})
    ...
    methods (Access = protected)
        ...
        function maskDisplay = getMaskDisplayImpl(obj)
            ...
            maskDisplay = { ...
                ...
                'color(''black'')', ...
                paramNameText, ...
                'text(52, 60, ''Get Parameter'', ''horizontalAlignment'', ''center'');', ...
                portLabelText{:}};
        end
    ...
    methods(Access = protected)
        function setStateHandler(obj, isScalar)
            ...
            if isScalar
                obj.StateHandler = robotics.slros.internal.block.GetParameterScalarState;
            else
                obj.StateHandler = robotics.slros.internal.block.GetParameterArrayState;
            end
        end                
    end
    ...
    methods(Static, Access = protected)
        ...
        function header = getHeaderImpl
            ...
            header = matlab.system.display.Header(mfilename('class'), ...
                'Title', message('robotics:robotslros:blockmask:GetParameterTitle').getString, ...
                'Text', message('robotics:robotslros:blockmask:GetParameterDescription').getString, ...
