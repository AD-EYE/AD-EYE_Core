classdef ReadPointCloud < robotics.slros.internal.block.ReadXBase ...
    ...
    properties(Nontunable, Logical)
        %PreserveStructure Preserve point cloud structure
        PreserveStructure = false
        
        %ShowRGBOutput Show RGB output port
        ShowRGBOutput = false;
        
        %ShowIntensityOutput Show Intensity output port
        ShowIntensityOutput = false;
    end
    ...
    properties(Nontunable)
        ...
        %MaximumPointCloudSize Maximum point cloud size
    ...
    properties (Constant, Access = {...
        ...
        InvalidTypeID = 'robotics:robotslros:pointcloud:InvalidType'
    end
    ...
    properties(Constant, Hidden)
        ...
        Reader = robotics.ros.msg.sensor_msgs.internal.PointCloud2Reader;
    end
    ...
    methods(Access = protected)
        ...
        function setupImpl(obj, ~)
            ...
            setupImpl@robotics.slros.internal.block.ReadXBase(obj);
        ...
        function varargout = stepImpl(obj,busstruct)
            ...
            pc = robotics.slros.internal.block.PointCloud2BusWrapper(busstruct);
            ...
            if obj.PreserveStructure
                ...
                coder.internal.assert(minHeight <= blockHeight, ...
                    'robotics:robotslros:cgen:InferenceAssertion')
    ...
    methods(Access = protected, Static)
        ...
        function group = getPropertyGroupsImpl
            ...
            pointCloudGroup = robotics.slros.internal.block.mixin.ConfigureUsingROS.getConfigurableSettingsGroup( ...
                slrosBlockmaskMessage('PointCloudPropertiesPrompt'), ...
                {'MaximumPointCloudSize'}, ...
                message('robotics:robotslros:topicselector:PointCloudDialogTitle').string);
        ...
        function topicSelector = generateTopicTable(node, varargin)
            topicSelector = robotics.slros.internal.PointCloudTopicTable(node, varargin{:});
        end
    end
end
