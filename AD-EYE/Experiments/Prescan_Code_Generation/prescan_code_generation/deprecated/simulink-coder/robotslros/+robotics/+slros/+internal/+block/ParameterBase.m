classdef (Abstract) ParameterBase < ...
    ...
    methods (Access = protected)
        ...
        function s = saveObjectImpl(obj)
            ...
            coder.internal.error('robotics:robotslros:nodedependent:SimStateNotSupported', ...
        ...
        function initializeParameterStream(obj, modelState)
            ...
            if ~isempty(obj.StreamWSVar)
                ...
                if isequal(obj.ModelName, obj.DefaultModelName)
                    modelName = '';
                else
                    modelName = obj.ModelName;
                end
                obj.ParameterStream = robotics.slros.internal.evalinGlobalScope(modelName, obj.StreamWSVar);
