classdef GetParameterBlockMask < robotics.slros.internal.block.CommonParameterMask
    ...
    methods       
        function updateSubsystem(~, block)
            ...
            blockId = robotics.slros.internal.block.getCppIdentifierForBlock(block, 'ParamGet_');
    ...
    methods (Access = protected)
        function setParameterType(obj, block)
            ...
            if ~robotics.slros.internal.sim.DataTypes.isSimulinkDataTypeScalar(maskValues{obj.MaskParamIndex.ParamDataTypeDropdown})
        ...
        function selectParameterDialogCloseCallback(obj, isAcceptedSelection, selectedParam, selectedParamType, block)
            ...
            selectParameterDialogCloseCallback@robotics.slros.internal.block.CommonParameterMask( ...
    ...
    methods(Static)
        function dispatch(methodName, varargin)
            ...
            obj = robotics.slros.internal.block.GetParameterBlockMask();
