classdef TableViewer < robotics.core.internal.mixin.SetProperties 
    ...
    %
    %  Sample use:
    %   selector = robotics.slros.internal.dlg.TableViewer(["Col1", "Col2"], "Title", "Select Something");
    ...
    %   Copyright 2017-2018 The MathWorks, Inc.
     ...
     properties (Constant, Access = {?robotics.slros.internal.dlg.TableViewer, ...
     ...
     properties(Access = {?robotics.slros.internal.dlg.TableViewer, ...
                                     ?matlab.unittest.TestCase})
