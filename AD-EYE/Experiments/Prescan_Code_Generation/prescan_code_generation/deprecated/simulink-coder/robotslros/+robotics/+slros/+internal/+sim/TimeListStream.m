classdef TimeListStream < robotics.slros.internal.sim.TimeStream
    ...
    methods
        function currentTime = getTime(obj)
            ...
            if isempty(obj.TimeList)
                error("robotics:slros:internal:TimeListEmpty", "Cannot retrieve time, because the TimeList cell array is empty.");
            end
