classdef VarLenArrayInfo < handle
    ...
    %   It is used when saving and retriving info about maximum sizes of
    ...
    %
    %   Sample invocation:
    %    msginfo = robotics.slros.internal.bus.VarLenArrayInfo(bus)
    %    msginfo = robotics.slros.internal.bus.VarLenArrayInfo('geographic_msgs/WayPoint', gcs)
    ...
    methods
        function obj = VarLenArrayInfo(varargin)
            ...
            if nargin == 1
                ...
                bus = robotics.slros.internal.bus.Util.getBusObjectFromMsgType(msgType, modelName);
            end
    ...
    %%
    methods(Access = {?robotics.slros.internal.bus.VarlenArraySizeStore, ?matlab.unittest.TestCase})
