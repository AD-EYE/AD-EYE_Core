classdef DiagnosticViewerStream < robotics.slros.internal.diag.IDiagnosticStream
...
%   Copyright 2016-2019 The MathWorks, Inc.
    ...
    methods
        ...
        %   section.
            ...
            if obj.BringViewerInFocus && robotics.slros.internal.isDisplayAvailable
        ...
        %reportError Report error message
            ...
            if isequal(obj.RunMode, 'build')
                % At build time, throw error
                sldiagviewer.reportError(diag);
                %throwAsCaller(diag);
            else
                % At test time, just display the error
                sldiagviewer.reportError(diag);
            end
        end
    end
