classdef ModelStateManager
    ...
    methods(Static)
        ...
        function out = hasState(modelName)
            ...
            map = robotics.slros.internal.sim.ModelStateManager.getInstance;
        ...
        function state = getState(modelName, flag)
            ...
            elseif strcmpi(flag, 'create')
                state = robotics.slros.internal.sim.ModelState;
                map(modelName) = state; %#ok<NASGU>
            else
                state = robotics.slros.internal.sim.ModelState.empty;
            end
        end        
