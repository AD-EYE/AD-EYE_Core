classdef ParameterSelector < handle
    ...
    % 
    %  Sample use:
    %   selector = robotics.slros.internal.dlg.ParameterSelector;
    ...
    methods      
        ...
        function dlg = openDialog(obj, closeFcnHandle)          
            ...
            obj.ParameterTypes = cellfun(@(x) robotics.slros.internal.sim.DataTypes.matlabToSimulinkTypeLabel(x), ...
            ...
            if numel(obj.ParameterList) == 0
                ...
                obj.ParameterList{1} = message('robotics:robotslros:paramselector:NoParametersFound').getString;
    ...
    methods
        ...
        function dlgstruct = getDialogSchema(obj)
            ...
            % Main dialog
            dlgstruct.DialogTitle = message('robotics:robotslros:paramselector:DialogTitle').getString;
            ...
            mytable.Editable = 0;
            mytable.ColHeader = { ...
               message('robotics:robotslros:paramselector:ColumnParamName').getString() ...
               message('robotics:robotslros:paramselector:ColumnParamType').getString() ...
               };
