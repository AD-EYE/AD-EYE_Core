    ...
    methods (Static)
        ...
        function mlDataType = simulinkToMatlab( slDataType )
            ...
            switch slDataType
                ...
                case 'boolean'
                    mlDataType = 'logical';
                case robotics.slros.internal.sim.DataTypes.SimulinkStringType
                    % This is a string
                    mlDataType = 'uint8';
                otherwise
                    error(message('robotics:robotslros:getparam:DataTypeSourceNotValid', slDataType));
            end
        ...
        function slDataType = matlabToSimulinkTypeLabel( mlDataType )
            ...
            switch mlDataType
                ...
                case 'uint8'
                    slDataType = robotics.slros.internal.sim.DataTypes.SimulinkStringType;
                case 'logical'
                    slDataType = 'boolean';
                case 'char'
                    slDataType = robotics.slros.internal.sim.DataTypes.SimulinkStringType;
                case 'cell'
                    ...
                    slDataType = 'list';
                otherwise
                    error(message('robotics:robotslros:getparam:DataTypeSourceNotValid', mlDataType));
            end
        ...
        function rosCppDataType = simulinkToROSCpp( slDataType, isArray )
            ...
            % array type.
            if strcmp(slDataType, robotics.slros.internal.sim.DataTypes.SimulinkStringType)
