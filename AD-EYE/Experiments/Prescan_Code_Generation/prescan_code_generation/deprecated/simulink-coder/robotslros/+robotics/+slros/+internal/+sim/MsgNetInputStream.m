classdef  MsgNetInputStream <  robotics.slros.internal.sim.MsgInputStream
    ...
    methods        
        ...
        function obj = MsgNetInputStream(topic, msgType, nodeObj)  
            ...
            if ~exist('nodeObj', 'var')
                ...
                obj.Subscriber = robotics.ros.Subscriber(nodeObj, obj.Topic, obj.MessageType);
            end
        end
        ...
        function [isNewMsg, msg] = getLatestMessage(obj)
            ...
            elseif msg.isImplIdenticalTo(obj.LastSeenMsg)
                isNewMsg = false;
            else % really new msg
                isNewMsg = true;
                obj.LastSeenMsg = msg;
