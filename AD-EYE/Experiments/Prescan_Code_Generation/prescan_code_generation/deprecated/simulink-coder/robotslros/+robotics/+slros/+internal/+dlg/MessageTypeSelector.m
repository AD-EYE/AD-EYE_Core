classdef MessageTypeSelector < handle
    ...
    %  from a list of ROS message types. Once the user accepts the changes
    %  (or cancels the dialog), a callback is invoked with the closure
    %  action and selected message type.
    % 
    %  Sample use:
    %   selector = robotics.slros.internal.dlg.MessageTypeSelector;
    ...
    methods       
        ...
        function dlg = openDialog(obj, initialMsgSelection, closeFcnHandle)
            ...
            obj.MessageList = robotics.slros.internal.ROSUtil.getMessageTypesWithoutServices;
            ...
            if ~isempty(index)
                ...
                warning(message('robotics:robotslros:msgselector:MessageTypeNotFound', ...
                    initialMsgSelection));
            end
        end
    end
    ...
    methods(Hidden)
        ...
        function dlgstruct = getDialogSchema(obj)
            ...
            % Main dialog
            dlgstruct.DialogTitle = message('robotics:robotslros:msgselector:DialogTitle').getString;
