classdef ReadImage <  robotics.slros.internal.block.ReadXBase ...
        & robotics.slros.internal.block.mixin.ConfigureUsingROS
    ...
    properties(Nontunable, Logical)
        %ShowAlphaOutput Show Alpha output port
        ShowAlphaOutput = false;
    end
    ...
    properties (Constant, Access = {...
        ...
        InvalidTypeID = 'robotics:robotslros:image:InvalidType'
    end
    
    properties (Nontunable, Access = private)
        %ImageEncodingInternal
        ImageEncodingInternal = robotics.ros.msg.sensor_msgs.internal.ImageEncoding.info('rgb8');
    end
    ...
    properties (Constant, Access = {?matlab.unittest.TestCase, ?robotics.slros.internal.block.ReadImage})
    ...
    properties(Constant, Hidden)
        ImageEncodingSet = matlab.system.StringSet( ...
            robotics.ros.msg.sensor_msgs.internal.ImageEncoding.NonBayerEncodings);
    end
    ...
    methods
        ...
        function set.ImageEncoding(obj, val)
            obj.ImageEncodingInternal = ...
                robotics.ros.msg.sensor_msgs.internal.ImageEncoding.info(coder.const(val));
        end
    ...
    methods (Access = protected)
        ...
        function varargout = stepImpl(obj,busstruct)
            ...
            errorCode = obj.update(busstruct);
        ...
        function errorCode = update(obj, busstruct)
        ...
        function [image, errorCode] = decodeImage(obj, data, width, height)
            ...
            if obj.HasAlpha
                [tempImage, alpha] = ...
                    robotics.ros.msg.sensor_msgs.internal.ImageReader.readImage( ...
        ...
        function validateInputsImpl(obj,~)
            validateInputsImpl@robotics.slros.internal.block.ReadXBase(obj);
        ...
        function varargout = getOutputSizeImpl(obj)
            ...
            [varargout{:}] = getOutputSizeImpl@robotics.slros.internal.block.ReadXBase(obj);
            if obj.HasAlpha
        ...
        function varargout = getOutputDataTypeImpl(obj)
            ...
            varargout = cell(1, nargout);
            [varargout{:}] = getOutputDataTypeImpl@robotics.slros.internal.block.ReadXBase(obj);
        ...
        function varargout = isOutputComplexImpl(obj)
            ...
            varargout = cell(1, nargout);
            [varargout{:}] = isOutputComplexImpl@robotics.slros.internal.block.ReadXBase(obj);
        ...
        function varargout = isOutputFixedSizeImpl(obj)
            ...
            varargout = cell(1, nargout);
            [varargout{:}] = isOutputFixedSizeImpl@robotics.slros.internal.block.ReadXBase(obj);
        ...
        function varargout = getOutputNamesImpl(obj)
            ...
            varargout = cell(1, nargout);
            [varargout{:}] = getOutputNamesImpl@robotics.slros.internal.block.ReadXBase(obj);
            varargout{1} = 'Image';
            if obj.ShowAlphaOutput && obj.HasAlpha
                varargout{2} = 'Alpha';
            end
        ...
        function num = getNumOutputsImpl(obj)
            ...
            num = num + getNumOutputsImpl@robotics.slros.internal.block.ReadXBase(obj);
        end
    ...
    methods(Access = protected, Static)
        ...
        function group = getPropertyGroupsImpl
            ...
            imageGroup = robotics.slros.internal.block.mixin.ConfigureUsingROS.getConfigurableSettingsGroup( ...
                slrosBlockmaskMessage('ImagePropertiesPrompt'), ...
                {'MaximumImageSize', 'ImageEncoding'}, ...
                message('robotics:robotslros:topicselector:ImageDialogTitle').string, ...
                'DependOnPrivatePropertyList', {'ImageEncoding'});
            outputGroup = robotics.slros.internal.block.ReadXBase.getOutputPropertyGroup( ...
                'ShowAlphaOutput');
            group = [imageGroup, outputGroup];
        end
        
        function topicSelector = generateTopicTable(node, varargin)
            topicSelector = robotics.slros.internal.ImageTopicTable(node, varargin{:});
        end
    end
end
...
function str = slrosBlockmaskMessage(key, varargin)
    str = getString(message(['robotics:robotslros:blockmask:' key], varargin{:}));
end
