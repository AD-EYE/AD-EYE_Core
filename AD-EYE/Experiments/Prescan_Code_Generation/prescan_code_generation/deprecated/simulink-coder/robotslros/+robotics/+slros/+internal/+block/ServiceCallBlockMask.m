classdef ServiceCallBlockMask < robotics.slros.internal.block.CommonServiceMask
    ...
    methods     
        ...
        function updateSubsystem(obj, block)
            ...
            [inputBusDataType,slInputBusName, outputBusDataType, slOutputBusName] = ...
                robotics.slros.internal.bus.Util.rosServiceTypeToDataTypeStr(rosServiceType, bdroot(block));
            
            % note: we use the block id of the parent, not the sys_obj block
            blockId = robotics.slros.internal.block.getCppIdentifierForBlock(block, 'ServCall_'); 
    ...
    methods(Static)
        ...
        function dispatch(methodName, varargin)
            ...
            obj = robotics.slros.internal.block.ServiceCallBlockMask;
