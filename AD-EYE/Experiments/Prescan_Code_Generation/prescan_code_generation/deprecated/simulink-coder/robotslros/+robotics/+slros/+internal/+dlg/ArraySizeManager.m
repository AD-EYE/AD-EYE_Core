classdef ArraySizeManager < handle
    ...
    methods
         ...
         function obj = ArraySizeManager(modelname)
             ...
             robotics.slros.internal.bus.Util.clearSLBusesInGlobalScope(modelname);
             ...
             for i=1:numel(allMsgsTypesInModel)      
                 ...
                 msginfo = robotics.slros.internal.bus.VarLenArrayInfo(msgType, modelname);                 
        ...
        function dlgstruct = getDialogSchema(obj)            
            ...
            dlgstruct.DialogTag = robotics.slros.internal.dlg.ArraySizeManager.getDialogTag(obj.ModelName);
        end
    end
    ...
    methods(Static)
        ...
        function launch(modelname)
            ...
            mgr = robotics.slros.internal.dlg.findAndBringToFront('robotics.slros.internal.dlg.ArraySizeManager', ...
                robotics.slros.internal.dlg.ArraySizeManager.getDialogTag(modelname), ...
