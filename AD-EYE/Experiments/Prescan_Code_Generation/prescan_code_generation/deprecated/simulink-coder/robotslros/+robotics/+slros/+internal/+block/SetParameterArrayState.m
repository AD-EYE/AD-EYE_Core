classdef SetParameterArrayState < robotics.slros.internal.block.SetParameterStateInterface
    ...
    methods
        ...
        function value = simulationStepImpl(obj, mlDataType, varargin)
            ...
            if arrayLength > length(value)
                ...
                % actual array
                ex = MException(message('robotics:robotslros:setparam:LengthLargerThanArray', ...
