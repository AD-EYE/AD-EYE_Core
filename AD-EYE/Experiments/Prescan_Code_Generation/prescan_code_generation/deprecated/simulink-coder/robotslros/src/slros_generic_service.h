...
class SimulinkServiceCaller
{
    public:
        ...
        uint8_T createServiceCaller(const std::string& serviceName, bool persistent, double connectionTimeout);
 ...
 */
template <class SrvType, class ReqBusType, class RespBusType>
uint8_T SimulinkServiceCaller<SrvType,ReqBusType,RespBusType>::createServiceCaller(const std::string& serviceName, bool isPersistent, double connectionTimeout)
{
    uint8_T errorCode = 0;
 ...
 */
template <class SrvType, class ReqBusType, class RespBusType>
uint8_T SimulinkServiceCaller<SrvType,ReqBusType,RespBusType>::call(ReqBusType* reqBusPtr, RespBusType* respBusPtr)
{
