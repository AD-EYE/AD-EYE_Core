...
function [u] = FILTER_PRESCAN_V2X_FIXED_CAM_camParameters(u, y)
  ...
  u.lowFrequencyContainer = FILTER_PRESCAN_V2X_FIXED_CAM_lowFrequencyContainer(u.lowFrequencyContainer, y.lowFrequencyContainer);
end
...
function [u] = FILTER_PRESCAN_V2X_FIXED_CAM_lowFrequencyContainer(u, y)
  u.basicVehicleContainerLowFrequency = FILTER_PRESCAN_V2X_FIXED_CAM_basicVehicleContainerLowFrequency(u.basicVehicleContainerLowFrequency, y.basicVehicleContainerLowFrequency);
end

function [u] = FILTER_PRESCAN_V2X_FIXED_CAM_basicVehicleContainerLowFrequency(u, y)
  u.vehicleRole = y.vehicleRole;
  u.exteriorLights = y.exteriorLights;
  u.pathHistory(1) = FILTER_PRESCAN_V2X_FIXED_CAM_pathHistory(u.pathHistory(1), y.pathHistory);
end

function [u] = FILTER_PRESCAN_V2X_FIXED_CAM_pathHistory(u, y)
  u.pathPosition = FILTER_PRESCAN_V2X_FIXED_CAM_pathPosition(u.pathPosition, y.pathPosition);
end

function [u] = FILTER_PRESCAN_V2X_FIXED_CAM_pathPosition(u, y)
  u.deltaLatitude = y.deltaLatitude;
  u.deltaLongitude = y.deltaLongitude;
  u.deltaAltitude = y.deltaAltitude;
end
