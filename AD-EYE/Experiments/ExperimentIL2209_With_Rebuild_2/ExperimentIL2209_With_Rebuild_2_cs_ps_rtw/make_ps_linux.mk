...
MODEL                = ExperimentIL2209_With_Rebuild_2_cs
MODULES              = rt_logging.c ExperimentIL2209_With_Rebuild_2_cs_capi.c ExperimentIL2209_With_Rebuild_2_cs_data.c ExperimentIL2209_With_Rebuild_2_cs_prescan.c detect_tunability_loss.c rtGetInf.c rtGetNaN.c rt_nonfinite.c prescan_LogHandler.c prescan_ErrorHandler.c prescan_Modify.c
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/adeye/AD-EYE_Core/AD-EYE/Experiments/ExperimentIL2209_With_Rebuild_2
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
...
NCSTATES             = 0
#####COMPUTER             = #>COMPUTER<#
BUILDARGS            =  MODELLIB=ExperimentIL2209_With_Rebuild_2_cslib.lib MAT_FILE=1 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
EXT_MODE             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/ExperimentIL2209_With_Rebuild_2_cs_ps_rtw \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
...
%.o : $(START_DIR)/ExperimentIL2209_With_Rebuild_2_cs_ps_rtw/%.c
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : $(START_DIR)/ExperimentIL2209_With_Rebuild_2_cs_ps_rtw/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
