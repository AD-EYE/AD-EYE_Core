  ...
  (RT_MODEL_ExperimentIL2209_Wit_T *const ExperimentIL2209_With_Rebuil_M)
{
  rtwCAPI_ModelMappingInfo* capiMap = &(rtmGetDataMapInfo
    (ExperimentIL2209_With_Rebuil_M).mmi);
  ...
  strcpy(csName,"ExperimentIL2209_With_Rebuild_2_cs");
  ...
  /* 0 : registry tuning variable = "ExperimentIL2209_With_Rebuild_2_cs_0c060923bf5c447f" type="real_T" size=1.0 */
  {
    real_T* ExperimentIL2209_With_Rebuild_2_cs_0c060923bf5c447f = (real_T*)
      prescan_CAPI_get_address_by_name(capiMap,
      "ExperimentIL2209_With_Rebuild_2_cs_0c060923bf5c447f");
    if (ExperimentIL2209_With_Rebuild_2_cs_0c060923bf5c447f == NULL) {
      printf("WARNING: Address not found. Possible loss of tunability detected for variable: <ExperimentIL2209_With_Rebuild_2_cs_0c060923bf5c447f>.\n");
    } else {
      *ExperimentIL2209_With_Rebuild_2_cs_0c060923bf5c447f = (real_T)
        (prescan_testautomation_find_path_id_by_actor_name(experimentHandle,
          "Mazda_RX8_Coupe_1"));
    }
  }

  /* 1 : registry tuning variable = "ExperimentIL2209_With_Rebuild_2_cs_a90dd231a019fe8f" type="real_T" size=1.0 */
  {
    real_T* ExperimentIL2209_With_Rebuild_2_cs_a90dd231a019fe8f = (real_T*)
      prescan_CAPI_get_address_by_name(capiMap,
      "ExperimentIL2209_With_Rebuild_2_cs_a90dd231a019fe8f");
    if (ExperimentIL2209_With_Rebuild_2_cs_a90dd231a019fe8f == NULL) {
      printf("WARNING: Address not found. Possible loss of tunability detected for variable: <ExperimentIL2209_With_Rebuild_2_cs_a90dd231a019fe8f>.\n");
    } else {
      *ExperimentIL2209_With_Rebuild_2_cs_a90dd231a019fe8f = (real_T)
