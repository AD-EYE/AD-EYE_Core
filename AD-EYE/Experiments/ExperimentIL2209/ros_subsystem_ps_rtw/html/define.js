function CodeDefine() { 
this.def = new Array();
this.def["ros_subsystem_DW"] = {file: "ros_subsystem_c.html",line:29,type:"var"};
this.def["ros_subsystem_U"] = {file: "ros_subsystem_c.html",line:32,type:"var"};
this.def["ros_subsystem_M_"] = {file: "ros_subsystem_c.html",line:35,type:"var"};
this.def["ros_subsystem_M"] = {file: "ros_subsystem_c.html",line:36,type:"var"};
this.def["ros_subsystem.c:matlabCodegenHandle_matlabCodeg"] = {file: "ros_subsystem_c.html",line:40,type:"fcn"};
this.def["ros_subsystem.c:ros_subsystem_output"] = {file: "ros_subsystem_c.html",line:48,type:"fcn"};
this.def["ros_subsystem.c:ros_subsystem_update"] = {file: "ros_subsystem_c.html",line:66,type:"fcn"};
this.def["ros_subsystem.c:ros_subsystem_initialize"] = {file: "ros_subsystem_c.html",line:87,type:"fcn"};
this.def["ros_subsystem.c:ros_subsystem_terminate"] = {file: "ros_subsystem_c.html",line:118,type:"fcn"};
this.def["MdlOutputs"] = {file: "ros_subsystem_c.html",line:130,type:"fcn"};
this.def["MdlUpdate"] = {file: "ros_subsystem_c.html",line:136,type:"fcn"};
this.def["MdlInitializeSizes"] = {file: "ros_subsystem_c.html",line:142,type:"fcn"};
this.def["MdlInitializeSampleTimes"] = {file: "ros_subsystem_c.html",line:146,type:"fcn"};
this.def["MdlInitialize"] = {file: "ros_subsystem_c.html",line:150,type:"fcn"};
this.def["MdlStart"] = {file: "ros_subsystem_c.html",line:154,type:"fcn"};
this.def["MdlTerminate"] = {file: "ros_subsystem_c.html",line:159,type:"fcn"};
this.def["ros_subsystem"] = {file: "ros_subsystem_c.html",line:165,type:"fcn"};
this.def["DW_ros_subsystem_T"] = {file: "ros_subsystem_h.html",line:849,type:"type"};
this.def["ExtU_ros_subsystem_T"] = {file: "ros_subsystem_h.html",line:854,type:"type"};
this.def["SL_Bus_ros_subsystem_std_msgs_Float32"] = {file: "ros_subsystem_types_h.html",line:32,type:"type"};
this.def["robotics_slros_internal_block_T"] = {file: "ros_subsystem_types_h.html",line:43,type:"type"};
this.def["P_ros_subsystem_T"] = {file: "ros_subsystem_types_h.html",line:48,type:"type"};
this.def["RT_MODEL_ros_subsystem_T"] = {file: "ros_subsystem_types_h.html",line:51,type:"type"};
this.def["ros_subsystem_P"] = {file: "ros_subsystem_data_c.html",line:25,type:"var"};
...
this.def["ros_subsystem_capi.c:rtBlockParameters"] = {file: "ros_subsystem_capi_c.html",line:43,type:"var"};
this.def["ros_subsystem_capi.c:rtModelParameters"] = {file: "ros_subsystem_capi_c.html",line:56,type:"var"};
this.def["ros_subsystem_capi.c:rtDataAddrMap"] = {file: "ros_subsystem_capi_c.html",line:64,type:"var"};
this.def["ros_subsystem_capi.c:rtVarDimsAddrMap"] = {file: "ros_subsystem_capi_c.html",line:69,type:"var"};
this.def["ros_subsystem_capi.c:rtDataTypeMap"] = {file: "ros_subsystem_capi_c.html",line:76,type:"var"};
this.def["ros_subsystem_capi.c:rtElementMap"] = {file: "ros_subsystem_capi_c.html",line:90,type:"var"};
this.def["ros_subsystem_capi.c:rtDimensionMap"] = {file: "ros_subsystem_capi_c.html",line:98,type:"var"};
this.def["ros_subsystem_capi.c:rtDimensionArray"] = {file: "ros_subsystem_capi_c.html",line:104,type:"var"};
this.def["ros_subsystem_capi.c:rtFixPtMap"] = {file: "ros_subsystem_capi_c.html",line:110,type:"var"};
this.def["ros_subsystem_capi.c:rtSampleTimeMap"] = {file: "ros_subsystem_capi_c.html",line:116,type:"var"};
this.def["ros_subsystem_capi.c:mmiStatic"] = {file: "ros_subsystem_capi_c.html",line:123,type:"var"};
this.def["ros_subsystem_GetCAPIStaticMap"] = {file: "ros_subsystem_capi_c.html",line:157,type:"fcn"};
this.def["ros_subsystem_InitializeDataMapInfo"] = {file: "ros_subsystem_capi_c.html",line:165,type:"fcn"};
this.def["ros_subsystem_host_InitializeDataMapInfo"] = {file: "ros_subsystem_capi_c.html",line:198,type:"fcn"};
...
this.def["prescan_CAPI_find"] = {file: "detect_tunability_loss_c.html",line:24,type:"fcn"};
this.def["mexFunction"] = {file: "detect_tunability_loss_c.html",line:42,type:"fcn"};
this.def["ros_subsystem_host_DataMapInfo_T"] = {file: "ros_subsystem_capi_host_h.html",line:9,type:"type"};
this.def["prescan_CAPI_get_address_by_name"] = {file: "ros_subsystem_prescan_c.html",line:11,type:"fcn"};
this.def["ros_subsystem_prescan_parameters"] = {file: "ros_subsystem_prescan_c.html",line:32,type:"fcn"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["ros_subsystem_c.html"] = "../ros_subsystem.c";
	this.html2Root["ros_subsystem_c.html"] = "ros_subsystem_c.html";
	...
	this.html2SrcPath["ros_subsystem_data_c.html"] = "../ros_subsystem_data.c";
	this.html2Root["ros_subsystem_data_c.html"] = "ros_subsystem_data_c.html";
	...
	this.html2SrcPath["ros_subsystem_capi_c.html"] = "../ros_subsystem_capi.c";
	this.html2Root["ros_subsystem_capi_c.html"] = "ros_subsystem_capi_c.html";
	this.html2SrcPath["ros_subsystem_capi_h.html"] = "../ros_subsystem_capi.h";
	this.html2Root["ros_subsystem_capi_h.html"] = "ros_subsystem_capi_h.html";
	...
	this.html2SrcPath["ros_subsystem_capi_host_h.html"] = "../ros_subsystem_capi_host.h";
	this.html2Root["ros_subsystem_capi_host_h.html"] = "ros_subsystem_capi_host_h.html";
	this.html2SrcPath["ros_subsystem_prescan_c.html"] = "../ros_subsystem_prescan.c";
	this.html2Root["ros_subsystem_prescan_c.html"] = "ros_subsystem_prescan_c.html";
	this.html2SrcPath["ros_subsystem_prescan_h.html"] = "../ros_subsystem_prescan.h";
	this.html2Root["ros_subsystem_prescan_h.html"] = "ros_subsystem_prescan_h.html";
...
var fileList = [
"ros_subsystem_c.html","ros_subsystem_h.html","ros_subsystem_private_h.html","ros_subsystem_types_h.html","ros_subsystem_data_c.html","builtin_typeid_types_h.html","multiword_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_defines_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html","zero_crossing_types_h.html","ros_subsystem_capi_c.html","ros_subsystem_capi_h.html","rtmodel_h.html","detect_tunability_loss_c.html","ros_subsystem_capi_host_h.html","ros_subsystem_prescan_c.html","ros_subsystem_prescan_h.html","rt_logging_c.html"];
