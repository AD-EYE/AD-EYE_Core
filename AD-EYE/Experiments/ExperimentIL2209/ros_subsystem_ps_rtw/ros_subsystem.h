...
#define ros_subsystem_rtModel          RT_MODEL_ros_subsystem_T
...
#define rtU                            ros_subsystem_U
#define ExternalInputs                 ExtU_ros_subsystem_T
#define rtP                            ros_subsystem_P
#define Parameters                     P_ros_subsystem_T
#define rtDWork                        ros_subsystem_DW
#define D_Work                         DW_ros_subsystem_T
 ...
 * External functions *
 *====================*/
extern ros_subsystem_rtModel *ros_subsystem(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  ros_subsystem_GetCAPIStaticMap(void);
