...
MODEL                = Subsystem0
MODULES              = rt_logging.c Subsystem0_capi.c Subsystem0_data.c Subsystem0_prescan.c detect_tunability_loss.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
NCSTATES             = 0
#####COMPUTER             = #>COMPUTER<#
BUILDARGS            =  MODELLIB=Subsystem0lib.lib MAT_FILE=1 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
EXT_MODE             = 0
...
%.o : $(START_DIR)/Subsystem0_ps_rtw/%.c
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : $(START_DIR)/Subsystem0_ps_rtw/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
