...
#include "Experiment_Prescan_Code_Generation_cs_capi_host.h"
                 ...
                 const mxArray *inputs[])
{
  ...
  Experiment_Prescan_Code_Generation_cs_host_DataMapInfo_T dataMap;
  ...
  /* Initialize CAPI. */
  Experiment_Prescan_Code_Generation_cs_host_InitializeDataMapInfo(&dataMap, 0);
  capiMap = &dataMap.mmi;
