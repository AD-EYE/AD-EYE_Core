...
double current_time, step_duration, tot_time;
double prev_time = 0;
double max_step = 0;
double min_step = 10000;
 ...
 *
 */
void sfunc_time_calc_Start_wrapper(void)
{
 ...
 *
 */
void sfunc_time_calc_Outputs_wrapper(void)
{
 ...
 *
 */
void sfunc_time_calc_Terminate_wrapper(void)
{
