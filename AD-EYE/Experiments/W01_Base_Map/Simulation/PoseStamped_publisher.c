 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Jan 20 15:12:46 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PoseStamped_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  2 */
#define IN_PORT_2_NAME        positionX
...
/* Input Port  3 */
#define IN_PORT_3_NAME        positionY
...
/* Input Port  4 */
#define IN_PORT_4_NAME        positionZ
...
/* Input Port  5 */
#define IN_PORT_5_NAME        orientationW
...
/* Input Port  6 */
#define IN_PORT_6_NAME        orientationX
...
/* Input Port  7 */
#define IN_PORT_7_NAME        orientationY
...
/* Input Port  8 */
#define IN_PORT_8_NAME        orientationZ
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *positionX = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *positionY = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *positionZ = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *orientationW = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *orientationX = (real_T *) ssGetInputPortRealSignal(S, 6);
    const real_T *orientationY = (real_T *) ssGetInputPortRealSignal(S, 7);
    const real_T *orientationZ = (real_T *) ssGetInputPortRealSignal(S, 8);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
