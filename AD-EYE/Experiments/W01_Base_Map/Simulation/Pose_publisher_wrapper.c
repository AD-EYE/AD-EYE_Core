 ...
 *
 */
void Pose_publisher_Start_wrapper(void **pW,
 ...
 *
 */
void Pose_publisher_Outputs_wrapper(const real_T *positionX,
...
publish_to_topic_pose(pW[0], topic_str, positionX[0], positionY[0], positionZ[0], orientationW[0], orientationX[0], orientationY[0], orientationZ[0]);
 ...
 *
 */
void Pose_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3)
