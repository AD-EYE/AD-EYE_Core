 ...
 *
 */
void Float32MultiArray_radar_publisher_Start_wrapper(void **pW,
 ...
 *
 */
void Float32MultiArray_radar_publisher_Outputs_wrapper(const real32_T *data,
			const real32_T *size,
			void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
 ...
 *
 */
void Float32MultiArray_radar_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3)
