/*
 * File: twiststamped_subscriber.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jan 15 04:56:08 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME twiststamped_subscriber
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       linear_x
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       linear_y
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       linear_z
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       angular_x
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       angular_y
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       angular_z
...
static void mdlStart(SimStruct *S)
{
    ...
    twiststamped_subscriber_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
{
    void **pW = ssGetPWork(S);
    real_T *linear_x = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *linear_y = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *linear_z = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *angular_x = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *angular_y = (real_T *) ssGetOutputPortRealSignal(S, 4);
    real_T *angular_z = (real_T *) ssGetOutputPortRealSignal(S, 5);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    twiststamped_subscriber_Outputs_wrapper(linear_x, linear_y, linear_z, angular_x, angular_y, angular_z, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    twiststamped_subscriber_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
