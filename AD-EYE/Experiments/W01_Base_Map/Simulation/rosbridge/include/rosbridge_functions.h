...
int publish_to_topic_posestamped(int sock, char *topic, int seq, int frameId_length, double orientW, double orientX, double orientY, double orientZ, double angularZ, double linearAccX, double linearAccZ);
