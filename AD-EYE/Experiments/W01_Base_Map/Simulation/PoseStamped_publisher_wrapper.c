...
publish_to_topic_posestamped(pW[0], topic_str, seq[0], frameId_length[0], positionX[0], positionY[0], positionZ[0], orientationW[0], orientationX[0], orientationY[0], orientationZ[0]);
