 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jan 15 05:41:27 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TwistStamped_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  5 */
#define IN_PORT_5_NAME        angularX
...
/* Input Port  6 */
#define IN_PORT_6_NAME        angularY
...
/* Input Port  7 */
#define IN_PORT_7_NAME        angularZ
...
static void mdlStart(SimStruct *S)
{
    ...
    TwistStamped_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *linearX = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *linearY = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *linearZ = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *angularX = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *angularY = (real_T *) ssGetInputPortRealSignal(S, 6);
    const real_T *angularZ = (real_T *) ssGetInputPortRealSignal(S, 7);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    TwistStamped_publisher_Outputs_wrapper(seq, frameId_length, linearX, linearY, linearZ, angularX, angularY, angularZ, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    TwistStamped_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
