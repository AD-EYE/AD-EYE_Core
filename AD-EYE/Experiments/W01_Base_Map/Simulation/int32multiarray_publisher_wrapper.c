 ...
 *
 */
void int32multiarray_publisher_Start_wrapper(void **pW,
 ...
 *
 */
void int32multiarray_publisher_Outputs_wrapper(const real_T *data,
			const real_T *size,
			void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
...
publish_to_topic_int32multiarray(pW[0], topic_str, data, size[0]);
 ...
 *
 */
void int32multiarray_publisher_Terminate_wrapper(void **pW,
			const int8_T *topic, const int_T p_width0,
			const int8_T *message_type, const int_T p_width1,
			const real_T *port, const int_T p_width2,
			const real_T *timeout, const int_T p_width3)
