/*
 * File: int32multiarray_publisher.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jan 15 03:56:36 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME int32multiarray_publisher
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            2
/* Input Port  0 */
#define IN_PORT_0_NAME        data
#define INPUT_0_WIDTH         11
...
static void mdlStart(SimStruct *S)
{
    ...
    int32multiarray_publisher_Start_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
}
#endif /*  MDL_START */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *size = (real_T *) ssGetInputPortRealSignal(S, 1);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    ...
    int32multiarray_publisher_Outputs_wrapper(data, size, pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    int32multiarray_publisher_Terminate_wrapper(pW, topic, p_width0, message_type, p_width1, port, p_width2, timeout, p_width3);
