...
MODEL                = W01_Base_Map_cs
MODULES              = rt_logging.c W01_Base_Map_cs_capi.c W01_Base_Map_cs_data.c W01_Base_Map_cs_prescan.c detect_tunability_loss.c rtGetInf.c rtGetNaN.c rt_nonfinite.c prescan_LogHandler.c prescan_ErrorHandler.c prescan_Modify.c Float32MultiArray_publisher_wrapper.c rosbridge_functions.c Float32MultiArray_radar_publisher_wrapper.c Image_publisher_wrapper.c Imu_publisher_wrapper.c Int32_publisher_wrapper.c Odometry_publisher_wrapper.c PoseArray3_publisher_wrapper.c PoseStamped_publisher_wrapper.c Pose_publisher_wrapper.c TwistStamped_publisher_wrapper.c bool_publisher_wrapper.c clock_publisher_wrapper.c int16_subscriber_wrapper.c int32multiarray_publisher_wrapper.c twiststamped_subscriber_wrapper.c
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/adeye/AD-EYE_Core/AD-EYE/Experiments/W01_Base_Map/Simulation
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)/sys/lcc64/lcc64/lib64/ws2_32.lib
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
#####COMPUTER             = #>COMPUTER<#
BUILDARGS            =  MODELLIB=W01_Base_Map_cslib.lib MAT_FILE=1 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING         = 0
EXT_MODE             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/W01_Base_Map_cs_ps_rtw \
	-I$(MATLAB_ROOT)/extern/include \
	-I$(MATLAB_ROOT)/simulink/include \
	-I$(MATLAB_ROOT)/rtw/c/src \
	-I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common \
...
%.o : $(START_DIR)/W01_Base_Map_cs_ps_rtw/%.c
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
rt_logging.o : C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_logging.c
	@$(GCC_TEST_CMD) C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_logging.c $(GCC_TEST_OUT)
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_logging.c



%.o : $(START_DIR)/W01_Base_Map_cs_ps_rtw/%.cpp
	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
	$(CPP) -c $(CPPFLAGS) "$<"
