function exists = fieldexists(input_struct,field_to_find)
    ...
    for i = 2:length(fields)
        ...
        if length(current_searched_field) == 1
            ...
            if (length(tested_struct.(current_searched_field(1))) == 1) && not(iscell(tested_struct.(current_searched_field(1)))) && (isfield(tested_struct,current_searched_field(1)))
