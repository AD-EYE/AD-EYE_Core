...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%set parameters
                    ...
                    if(fieldexists(Struct_OpenSCENARIO, strcat("Struct_OpenSCENARIO.OpenSCENARIO.Storyboard.Init.Actions.Private{1,",num2str(x),"}.PrivateAction{1,",num2str(y),"}.LongitudinalAction.SpeedAction.SpeedActionDynamics.value")))
