  ...
  void load_pexmap(std::string filePex, pexmap & pm){
    ...
    if (!inputFile.is_open()){
      ...
      while (inputFile.good()){
        ...
        if(line.find("<NatureElement xsi") != std::string::npos || line.find("<Building xsi") != std::string::npos || line.find("<InfraOther xsi") != std::string::npos){
          // get type
          ...
          // get ID
          element = line.substr(line.find("UniqueId")+10, line.find("SensorIDDetection")-2-line.find("UniqueId")+10);
