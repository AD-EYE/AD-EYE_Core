...
{
   float RADCURVMUL2 = 2.0*RADCURV;
   float RADCURVMUL4 = 4.0*RADCURV;
...
double cscb(double x,double y,double phi,double rs,double rc,double *t,double *u,double *v, float RADCURV)
{
   float RADCURVMUL2 = 2.0*RADCURV;
   float RADCURVMUL4 = 4.0*RADCURV;
   float SQRADCURV = pow(RADCURV, 2.0);
   float SQRADCURVMUL2 = 4.0*pow(RADCURV, 2.0);
   double a,b,u1,theta,alpha,length_rs;
...
double reed_shepp(double x1,double y1,double t1,double x2,double y2,double t2,int *numero,double *tr,double *ur,double *vr)
{
  float RADCURVMUL2 = 2.0*RADCURV;
  float RADCURVMUL4 = 4.0*RADCURV;
  //extern float RADCURV,RADCURVMUL2,RADCURVMUL4;   double x,y,phi;
  double x,y,phi;
...
/*   C | C | C   */
   ...
   length = c_c_c(x,y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   num = 1;
   t = tn; u = un; v = vn;

   var = c_c_c(-x,y,-phi,am,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 2;
   ...
   var = c_c_c(-x,-y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 4;
...
/*   C | C C   */
   ...
   var = c_cc(x,y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 5;
   ...
   var = c_cc(-x,y,-phi,am,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 6;
...
/*   C S C   */
   ...
   var = csca(x,y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 9;
   ...
   var = csca(x,-y,-phi,am,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 10;
   ...
   var = cscb(x,y,phi,ap,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 13;
   ...
   var = cscb(x,-y,-phi,am,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 14;
...
/*   C Cu | Cu C   */
   ...
   var = ccu_cuc(x,y,phi,ap,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 17;
   ...
   var = ccu_cuc(x,-y,-phi,am,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 18;
...
/*   C | Cu Cu | C   */
   ...
   var = c_cucu_c(x,y,phi,ap,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 21;
   ...
   var = c_cucu_c(x,-y,-phi,am,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 22;
...
/*   C | C2 S C   */
   ...
   var = c_c2sca(x,y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 25;
   ...
   var = c_c2sca(x,-y,-phi,am,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 26;
   ...
   var = c_c2scb(x,y,phi,ap,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 29;
   ...
   var = c_c2scb(x,-y,-phi,am,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 30;
...
/*   C | C2 S C2 | C   */
   ...
   var = c_c2sc2_c(x,y,phi,ap,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 33;
   ...
   var = c_c2sc2_c(x,-y,-phi,am,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 34;
...
/*   C C | C   */
   ...
   var = cc_c(x,y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 37;
   ...
   var = cc_c(x,-y,-phi,am,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 38;
...
/*   C S C2 | C   */
   ...
   var = csc2_ca(x,y,phi,ap,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 41;
   ...
   var = csc2_ca(x,-y,-phi,am,b1,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 42;
   ...
   var = csc2_cb(x,y,phi,ap,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 45;
   ...
   var = csc2_cb(x,-y,-phi,am,b2,&tn,&un,&vn,RADCURV);
   if (var < length)
     {
       length = var;
       num = 46;
