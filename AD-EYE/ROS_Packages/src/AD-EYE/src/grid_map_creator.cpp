...
private:
    ...
    void addPrescanObjects(ros::NodeHandle& p_nh)
    {
        ...
        for(int i = 0; i < (int)pexObjects.roadSideParkingObjects.size(); i++){
            grid_map::Polygon polygon = createRectangle(pexObjects.roadSideParkingObjects.at(i).posX,
                                                        pexObjects.roadSideParkingObjects.at(i).posY,
                                                        pexObjects.roadSideParkingObjects.at(i).sizeX,
        ...
        for(int i = 0; i < (int)pexObjects.restAreaObjects.size(); i++){
            grid_map::Polygon polygon = createRectangle(pexObjects.restAreaObjects.at(i).posX,
                                                        pexObjects.restAreaObjects.at(i).posY,
                                                        pexObjects.restAreaObjects.at(i).sizeX,
