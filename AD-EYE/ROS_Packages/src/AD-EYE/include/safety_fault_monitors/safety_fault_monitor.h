...
class SafetyFaultMonitor
{
  ...
  public:
     ...
     * \param decrement_value How much the counter is decremented when the function tested is malfunctioning (should be
     * positive).
     * \param high_threshold Upper value at which the counter is saturated. When the counter reaches this value the test
     * is considered failed.
     * \param low_threshold Lower value at which the counter is saturated. When the counter reaches this value the test
