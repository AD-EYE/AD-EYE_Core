...
class VectorMap
{
  private:
    ...
    * \details For each line of the point file, append columns in id, x and y value into points_id_, points_x_ and
    * point_y vectors
    */
    ...
    * \details For each line of the lanes file, append columns in lanes_id_, lanes_did_, lanes_prevlane_,
    * lanes_nextlane_, lanes_startpoint_, lanes_endpoint_ vectors
    */
    ...
    * \details For each line of the nodes file, append columns in dtlanes-did_, dtlanes_leftwidth, dtlanes_rightwidth
    * vectors
    */
  ...
  public:
    ...
    */
    void loadVectormap(std::string points_file, std::string lanes_file, std::string nodes_file,
                       std::string dtlanes_file);
};
