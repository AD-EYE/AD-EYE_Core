...
/*!
 * \brief scenario16 node : Manages start and stop of the recording & experiment for scenario16
 */
class scenario16: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario16(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario16::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario16::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario16::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario16: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario16: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario16: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario16: stopped recording" << std::endl;
        }
        ...
        */
        bool stopExperimentConditionFulfilled()
        {
            ...
            return (non_ego_angle_ == 0 && non_ego_speed_ > 8);
        }
...
{
    ros::init(argc, argv, "scenario16");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario16" << std::endl;
    scenario16 scenario_16(private_nh, 20);
    scenario_16.run();
}