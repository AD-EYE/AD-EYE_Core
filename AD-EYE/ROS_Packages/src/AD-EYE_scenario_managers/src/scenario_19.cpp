...
/*!
 * \brief scenario19 node : Manages start and stop of the recording & experiment for scenario19
 */
class scenario19: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        ...
        {
            std::cout << "scenario19: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario19: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario19: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario19: stopped recording" << std::endl;
        }
