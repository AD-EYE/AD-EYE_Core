...
/*!
 * \brief scenario17 node : Manages start and stop of the recording & experiment for scenario17
 */
class scenario17 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario17(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario17::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario17::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario17::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario17: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario17: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario17: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario17: stopped recording" << std::endl;
    }
...
{
    ros::init(argc, argv, "scenario17");
    ros::NodeHandle private_nh("~");

    std::cout << "Creating scenario17" << std::endl;
    scenario17 scenario_17(private_nh, 20);
    scenario_17.run();
}