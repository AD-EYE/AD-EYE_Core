...
/*!
 * \brief scenario15 node : Manages start and stop of the recording & experiment for scenario15
 */
class scenario15 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario15(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario15::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario15::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario15::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario15: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario15: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario15: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario15: stopped recording" << std::endl;
    }
...
{
    ros::init(argc, argv, "scenario15");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario15" << std::endl;
    scenario15 scenario_15(private_nh, 20);
    scenario_15.run();
}