...
/*!
 * \brief scenario10 node : Manages start and stop of the recording & experiment for scenario10
 */
class scenario10 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario10(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario10::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario10::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario10::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario10: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario10: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario10: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario10: stopped recording" << std::endl;
    }
...
{
    ros::init(argc, argv, "scenario10");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario10" << std::endl;
    scenario10 scenario_10(private_nh, 20);
    scenario_10.run();
}