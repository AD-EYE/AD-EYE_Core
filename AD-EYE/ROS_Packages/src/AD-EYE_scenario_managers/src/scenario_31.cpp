...
/*!
 * \brief scenario31 node : Manages start and stop of the recording & experiment for scenario31
 */
class scenario31: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario31(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario31::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario31::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario31::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario31: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario31: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario31: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario31: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario31");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario31" << std::endl;
    scenario31 scenario_31(private_nh, 20);
    scenario_31.run();
}