...
/*!
 * \brief scenario20 node : Manages start and stop of the recording & experiment for scenario20
 */
class scenario20 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario20(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario20::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario20::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario20::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario20: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario20: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario20: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario20: stopped recording" << std::endl;
    }
