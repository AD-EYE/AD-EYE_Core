...
/*!
 * \brief scenario6 node : Manages start and stop of the recording & experiment for scenario6
 */
class scenario6: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario6(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario6::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario6::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario6::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario6: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario6: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario6: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario6: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario6");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario6" << std::endl;
    scenario6 scenario_6(private_nh, 20);
    scenario_6.run();
}