...
/*!
 * \brief scenario5 node : Manages start and stop of the recording & experiment for scenario5
 */
class scenario5: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario5(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario5::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario5::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario5::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario5: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario5: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario5: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario5: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario5");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario5" << std::endl;
    scenario5 scenario_5(private_nh, 20);
    scenario_5.run();
}