...
/*!
 * \brief scenario2 node : Manages start and stop of the recording & experiment for scenario2
 */
class scenario2: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario2(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario2::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario2::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario2::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario2: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario2: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario2: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario2: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario2");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario2" << std::endl;
    scenario2 scenario_2(private_nh, 20);
    scenario_2.run();
}