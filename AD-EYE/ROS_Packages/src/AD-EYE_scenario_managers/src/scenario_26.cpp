    ...
    public:
        ...
        */
        scenario26(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            ...
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity_1", 10, &scenario26::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity_1", 10, &scenario26::speedCallback3, this);
            speed_sub4_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity_2", 10, &scenario26::speedCallback4, this);
        }
