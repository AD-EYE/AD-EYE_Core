...
/*!
 * \brief scenario27 node : Manages start and stop of the recording & experiment for scenario27
 */
class scenario27: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario27(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario27::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario27::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario27::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario27: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario27: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario27: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario27: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario27");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario27" << std::endl;
    scenario27 scenario_27(private_nh, 20);
    scenario_27.run();
}