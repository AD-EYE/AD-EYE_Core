...
/*!
 * \brief scenario23 node : Manages start and stop of the recording & experiment for scenario23
 */
class scenario23: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario23(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario23::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario23::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario23::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario23: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario23: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario23: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario23: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario23");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario23" << std::endl;
    scenario23 scenario_23(private_nh, 20);
    scenario_23.run();
}