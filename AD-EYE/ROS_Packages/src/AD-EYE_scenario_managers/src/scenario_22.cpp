...
/*!
 * \brief scenario22 node : Manages start and stop of the recording & experiment for scenario22
 */
class scenario22 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario22(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario22::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario22::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario22::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario22: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario22: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario22: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario22: stopped recording" << std::endl;
    }
    ...
    */
    ...
    {
        return (non_ego_speed_ > 19);
    }
};

int main(int argc, char** argv)
{
    ros::init(argc, argv, "scenario22");
    ros::NodeHandle private_nh("~");

    std::cout << "Creating scenario22" << std::endl;
    scenario22 scenario_22(private_nh, 20);
    scenario_22.run();
}