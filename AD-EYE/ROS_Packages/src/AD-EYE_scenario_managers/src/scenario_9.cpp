...
/*!
 * \brief scenario9 node : Manages start and stop of the recording & experiment for scenario9
 */
class scenario9: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario9(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario9::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario9::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario9::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario9: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario9: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario9: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario9: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario9");
    ros::NodeHandle private_nh("~");

    std::cout << "Creating scenario9" << std::endl;
    scenario9 scenario_9(private_nh, 20);
    scenario_9.run();
}