...
/*!
 * \brief scenario14 node : Manages start and stop of the recording & experiment for scenario14
 */
class scenario14: public ScenarioManagerTemplate {
    ...
    public:
        ...
        */
        scenario14(ros::NodeHandle nh, int frequency): ScenarioManagerTemplate(nh, frequency)
        {
            speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario14::speedCallback, this);
            // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
            speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario14::speedCallback2, this);
            speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario14::speedCallback3, this);
        }
        ...
        */
        ...
        {
            std::cout << "scenario14: started experiment" << std::endl;
        }
        ...
        */
        void stopExperiment()
        {
            std::cout << "scenario14: stopped experiment" << std::endl;
        }
        ...
        */
        void startRecording()
        {
            std::cout << "scenario14: started recording" << std::endl;
        }
        ...
        */
        void stopRecording()
        {
            std::cout << "scenario14: stopped recording" << std::endl;
        }
...
{
    ros::init(argc, argv, "scenario14");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario14" << std::endl;
    scenario14 scenario_14(private_nh, 20);
    scenario_14.run();
}