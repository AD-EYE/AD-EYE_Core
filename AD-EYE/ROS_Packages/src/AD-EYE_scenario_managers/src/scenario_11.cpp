...
/*!
 * \brief scenario11 node : Manages start and stop of the recording & experiment for scenario11
 */
class scenario11 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario11(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario11::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario11::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario11::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario11: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario11: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario11: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario11: stopped recording" << std::endl;
    }
...
{
    ros::init(argc, argv, "scenario11");
    ros::NodeHandle private_nh("~");

    std::cout << "Creating scenario11" << std::endl;
    scenario11 scenario_11(private_nh, 20);
    scenario_11.run();
}