...
/*!
 * \brief scenario24 node : Manages start and stop of the recording & experiment for scenario24
 */
class scenario24 : public ScenarioManagerTemplate
{
  private:
  ...
  public:
    ...
    */
    scenario24(ros::NodeHandle nh, int frequency) : ScenarioManagerTemplate(nh, frequency)
    {
        speed_sub_ = ScenarioManagerTemplate::nh_.subscribe("/current_velocity", 10, &scenario24::speedCallback, this);
        // ScenarioManagerTemplate::nh_.param<float>("/simulink/rain_intensity", rain_intensity_, 0.0);
        speed_sub2_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario24::speedCallback2, this);
        speed_sub3_ = ScenarioManagerTemplate::nh_.subscribe("/other_velocity", 10, &scenario24::speedCallback3, this);
    }
    ...
    */
    ...
    {
        std::cout << "scenario24: started experiment" << std::endl;
    }
    ...
    */
    void stopExperiment()
    {
        std::cout << "scenario24: stopped experiment" << std::endl;
    }
    ...
    */
    void startRecording()
    {
        std::cout << "scenario24: started recording" << std::endl;
    }
    ...
    */
    void stopRecording()
    {
        std::cout << "scenario24: stopped recording" << std::endl;
    }
...
{
    ros::init(argc, argv, "scenario24");
    ros::NodeHandle private_nh("~");

    std::cout << "Analyzing scenario24" << std::endl;
    scenario24 scenario_24(private_nh, 20);
    scenario_24.run();
}