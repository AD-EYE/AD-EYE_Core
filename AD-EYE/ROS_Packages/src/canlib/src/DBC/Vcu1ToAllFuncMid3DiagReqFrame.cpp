...
void Vcu1ToAllFuncMid3DiagReqFrame_Init(
    ...
    signals_info.insert({ Vcu1ToAllFuncMid3DiagReqNpdu, { Vcu1ToAllFuncMid3DiagReqNpdu, 56, 64, true, SignalType::APP_UNSIGNED, 0, Vcu1ToAllFuncMid3DiagReqFrame, ParentType::FRAME } });
