...
def create_parser(): 
    ...
    parser.add_argument("--rosbag-folder", type=str, default="/home/adeye/Mapping/Rosbags/", help="Path to rosbag files")
    parser.add_argument("--output-dir", type=str, default="/home/adeye/Mapping/PCL/", help="Path to PCD output dir")
...
class ProcessManager(): 
    ...
    def transform_imu(self):
        ...
        msg = rospy.wait_for_message("/ouster/imu", Imu) #This will create a new subscription to the topic, receive one message, then unsubscribe.
    ...
    def play_rosbag(self):
        ...
        cmd = ["rosrun", "topic_tools", "relay", "/ouster/points", "/points_raw"]
    ...
    def start_ndt_mapping(self):
        ...
        rospy.set_param("/ndt_mapping/imu_topic", "/ouster/imu")
