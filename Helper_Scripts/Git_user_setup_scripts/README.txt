...
- [Firtsname]_[LastName]_Windows_set_git_user_info.bat	: This script is used to quickly change your git name. Your name must be edited in the file. This script has to be run manualy, and you must not set it to run automatically.
...
- [Firtsname]_[LastName]_Ubuntu_set_git_user_info.sh 	: This script is used to quickly change your git name. Your name must be edited in the file. This script has to be run manualy, and you must not set it to run automatically.

- Ubuntu_set_git_user_info.sh   			: This script is not necessary and can be ignored. Its purpose is to allow the user to set his name and email in the git folder of his choice through prompts. It is therefore not quick, but it is more flexible.
...
2/ Follow this tutorial and the instructions below: https://winaero.com/run-app-or-script-at-logon-with-task-scheduler-in-windows-10/
...
NOTE :
For all of the ubuntu scripts, the command chmod should be used to make the script executable.
